...
Route::post('/invest/xpack', 'userController@xpack_invest');
Route::post('/wd/req/submit', 'userController@wd_req_submit');
Route::post('/user/send/fund', 'userController@user_send_fund');
Route::post('/user/request/change/pwd', 'userController@user_req_pwd');
Route::post('/user/update/pwd', 'userController@reset_pwd');
Route::post('/user/upload/profile_pic', 'userController@uploadProfilePic');
Route::post('/user/change/pwd', 'userController@changePwd');
Route::post('/user/update/profile', 'userController@updateProfile');
Route::post('/user/add/bank', 'userController@addbank');
Route::post('/user/invest/packages', 'userController@invest');
Route::post('/user/wdraw/earning', 'userController@wd_invest');
Route::post('/user/wallet/wd', 'userController@user_wallet_wd');
Route::post('/user/ref/wd', 'userController@user_ref_wd');
Route::post('/user/deposit/fund', 'userController@user_deposit_trans');
Route::post('/user/add/btc_wallet', 'userController@addBtcWallet');
