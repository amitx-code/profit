          ...
          <form id="wd_formssss" action="/user/deposit/fund" method="post" enctype="multipart/form-data">
              ...
              <div class="input-group" style="margin-top: 10px;">
                <div class="input-group-prepend" >
                  <span class="input-group-text "><?php echo e($user->currency); ?></span>
                </div>              
              ...
              <div class="input-group" style="margin-top: 10px;">
                <div class="input-group-prepend" >
                  <span class="input-group-text "><i class="fa fa-home" style="font-size: 10px;"></i></span>
                </div>                                      
                ...
                <center><label>Enter Amount to Deposit</label></center>
                  <div class="col-sm-12 form-group" style="margin-top: 10px;" >
                    <center>
                      ...
                      <input id="payAmt" type="number" class="form-control" style="width: 60%; text-align: center;" align="center" name="amount"  required placeholder="Enter amount you want to pay" >
                    </center>
                  </div>
              </div>
                ...
                <center><label>Enter Amount to Deposit</label></center>
                  <div class="col-sm-12 form-group" style="margin-top: 10px;" >
                    <center>
                      ...
                      <input type="number" class="form-control" style="width: 60%; text-align: center;" align="center" name="amt"  required placeholder="Enter amount you want to pay" >
...
</div><?php /**PATH C:\wamp64\www\dh\core\resources\views/user/inc/paymentforms.blade.php ENDPATH**/ ?>