	...
	<div id="p_loading" class="container" style="min-width: 100%; background-color: rgba(0,0,0,.6); position: fixed; top: 0; left: 0; bottom: 0; width: 100%; z-index: 1000; display: none;">
      <div class="row">
	...
	<?php if(isset($toast_msg) && $toast_msg->type == 'suc' ): ?>
		<script type="text/javascript">
			// $('#suc').html('<?php echo e($toast_msg->msg); ?>')
   //          $('#suc').show().animate({ width: "30%" }, "1000").delay(2000).animate({ width: "-50px" }, "1000").fadeOut(50);
		</script>
	<?php endif; ?>
	<?php if(isset($toast_msg) && $toast_msg->type == 'err' ): ?>
		<script type="text/javascript">
			// $('#err').html('<?php echo e($toast_msg->msg); ?>')
...
</html><?php /**PATH C:\wamp\www\soft.local\core\resources\views/admin/atlantis/footer.blade.php ENDPATH**/ ?>