...
<head>
	...
	<title>MaxiProfit - Complete Investment Package</title>
...
<body>
	<div class="wrapper">
				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<li class="nav-item dropdown hidden-caret">
							<a class="nav-link dropdown-toggle" href="/admin/send/msg" role="button">
								<?php                                  
	                                $msgs = App\msg::orderby('id', 'desc')->get();
	                            ?>								
								<i class="fa fa-bell not_cont">
					...
					<ul class="nav nav-primary">
					    <li class="nav-item">
							<a class="dropdown-item" href="/admin/home">
								<span class="fas fa-palette"></span>&nbsp; Dashboard
							</a>
						</li>
						<?php ($role = Session::get('adm')); ?>
                        <?php if($role->role == 3): ?>
                        	...
                        	<li class="nav-item">
								<a class="dropdown-item" href="/admin/manage/adminUsers">
									<span class="fa fa-user"></span>&nbsp; Manage Admin Users
								</a>
							</li>
							<li class="nav-item">
								<a class="dropdown-item" href="/admin/manage/investments">
									<span class="fas fa-hand-holding-usd"></span>&nbsp; Manage Investments
								</a>
							</li>
							<li class="nav-item">
								<a class="dropdown-item" href="/admin/manage/deposits">
							...
							<li class="nav-item">
								<a class="dropdown-item" href="/admin/manage/withdrawals">
									<span class="fas fa-arrow-circle-down"></span>&nbsp; User Withdrawal 
								</a>
							</li>
						<?php endif; ?>
		...
		<!-- End Sidebar --><?php /**PATH C:\wamp\www\soft.local\core\resources\views/admin/atlantis/header.blade.php ENDPATH**/ ?>