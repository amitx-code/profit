            ...
            <table class="display table table-stripped table-hover">
                <thead>
                    <tr>
                       ...
                       <th> <?php echo e(__('Daily Interest')); ?> </th>
                       <th> <?php echo e(__('Period')); ?> </th>
                       <th> <?php echo e(__('WD Interval')); ?> </th>
                       <th> <?php echo e(__('WD Fee')); ?> </th>
                            ...
                            <tr>
                                ...
                                <td>                                                                       
                                    <?php if($adm->role == 3 || $adm->role == 2): ?>
                                        <a id="<?php echo e($dep->id); ?>" title="Edit Package" href="javascript:void(0)" onclick="edit_pack(this.id, '<?php echo e($dep->min); ?>', '<?php echo e($dep->max); ?>', '<?php echo e($dep->daily_interest); ?>', '<?php echo e($dep->withdrwal_fee); ?>', '<?php echo e(csrf_token()); ?>', '<?php echo e($dep->currency); ?>')"> 
