<div id="div_withdrawal" class="container popmsgContainer" >
    <div class="row wd_row_pad" >
      ...
      <div class="col-md-4 card popmsg-mobile pop_invest_col" align="Center">        
        ...
        <div class="card-body" >                
          <p align="left" style="">
              <?php echo e(__('Withdrawable Amount')); ?> <span id="days" class="text-danger float-right" ></span>
              <br>
          </p>
          <form id="wd_formssss" action="/user/wdraw/earning" method="post">
              ...
              <div class="input-group">
                ...
                <input id="wd_amt" readonly type="text" class="form-control bg_white" name="amt"  required >
              </div>
  ...
  </div><?php /**PATH C:\wamp\www\soft.local\core\resources\views/user/inc/withdrawal.blade.php ENDPATH**/ ?>