...
<?php
    $user = Auth::User();  
    $myInv = App\investment::where('user_id', $user->id)->orderby('id', 'asc')->get();
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title">Deposit Using Stripe</div>
                                ...
                                <div class="card-body">
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-5" align="center" style="background-color: #EEE; padding: 60px 10px;">
                                            <i class="fab fa-cc-stripe fa-4x" style="color: #1269DB;">                                                
                                            </i>
                                            <p>
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superloc/mcode.me/maxprofit.mcode.me/core/resources/views/user/stripePayment.blade.php ENDPATH**/ ?>