                                                ...
                                                <div id="pay_cont" class="row">
                                                    ...
                                                    <div class="col-lg-6 mt-5">                                                                                                  
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <p>
                                                                <?php echo e(__('Pay using Bitcoin payment system')); ?>

                                                            </p> 
                                                           
                                                            <div align="">
                                                                <a href="<?php echo e(route('btc.index')); ?>" class="btn btn_blue" >
                                                    ...
                                                    <div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <p>
                                                                <?php echo e(__('Pay using Bank Depost/Transfer system')); ?>
                                            ...
                                            <?php if(count($deps) > 0 ): ?>
                                                <?php $__currentLoopData = $deps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr> 
                                                        ...
                                                        <td>
                                                            <?php if($dep->bank == 'BTC'): ?>
                                                                <a href="<?php echo e($dep->url); ?>" target="_blank" class="btn btn-info">Confirmation</a>
                                                            <?php endif; ?>
                                                        </td>                                                                       
                                                    </tr>
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\soft.local\core\resources\views/user/load_wallet.blade.php ENDPATH**/ ?>