			                                        	...
			                                        	<a id="<?php echo e($msg->id); ?>" href="javascript:void(0)" onclick="read(this.id, 'yes')">
															...
															<div class="msg_listing">
																...
																<div id="dis_not<?php echo e($msg->id); ?>" class="display_not">
																	<h3><b><?php echo $msg->subject; ?></b></h3>
			                                        ...
			                                        <?php else: ?>		                                            
			                                            <a id="<?php echo e($msg->id); ?>" href="javascript:void(0)" onclick="read(this.id, 'yes')">
															...
															<div class="msg_listing">
																...
																<div id="dis_not<?php echo e($msg->id); ?>" class="display_not">
																	<div align="center">
																		<h4 align="center"><b><?php echo $msg->subject; ?></b></h4>
																		<hr class="text-white"> 
																	</div>																	
																	<?php echo $msg->message; ?>
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dh\core\resources\views/user/messages.blade.php ENDPATH**/ ?>