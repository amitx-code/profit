            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-copy-right">
                        <p>Copyright &#169; <?php echo date("Y") ?> Diamond Hub Plus. All Rights Reserved. </p>
                    </div>
                </div>
            </div>
        </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5b4f013991379020b95ef904/default';
s1.charset='UTF-8';
...
<?php echo $__env->make('user.inc.alert', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 ...
 <?php if(Session::has('status')  && Session::get('msgType') == 'suc'): ?>         
    ...
    <?php endif; ?><?php /**PATH /home/diamondhubplus/public_html/wallet/resources/views/inc/foot.blade.php ENDPATH**/ ?>