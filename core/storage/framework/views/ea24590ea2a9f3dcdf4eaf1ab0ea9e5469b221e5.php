				...
				<div class="row py-3 <?php if($adm->role < 2): ?> <?php echo e(blur_cnt); ?><?php endif; ?>" style="position: relative;">
					<div class="col-md-6 d-flex flex-column justify-content-around">						
						<div style="border-bottom: 1px solid #CCC;">							
							...
							<h3 class="fw-bold">$ <?php echo e($cap); ?></h3>
					  ...
					  <div class="clearfix"><br></div>						
						<div>							
							...
							<h3 class="fw-bold">$ <?php echo e($dep); ?></h3>
							<div class="colhd" style="font-size: 10px; margin-top: -10px;">&emsp;</div>
							<br>									
						</div>
					</div>
					...
					<div class="col-md-6">
						<div style="border-bottom: 1px solid #CCC;">
							...
							<h3 class="fw-bold">$ <?php echo e($wd_bal); ?></h3>
							<div class="colhd" style="font-size: 10px; margin-top: -10px;">&emsp;</div>	
							<br>	
						</div>
					</div>
...
<?php /**PATH C:\wamp64\www\dh\core\resources\views/admin/atlantis/overview.blade.php ENDPATH**/ ?>