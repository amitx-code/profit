                            ...
                            <div class="card">
                                <div class="card-header" style="background-color: #127aff;">
                                    <div class="card-head-row card-tools-still-right">
                                        <h4 class="card-title" style="color: #fff;"> <i class="fas fa-hand-holding-usd"></i> User Investments</h4>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superloc/mcode.me/maxprofit.mcode.me/core/resources/views/admin/manageInv.blade.php ENDPATH**/ ?>