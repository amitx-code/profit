...
<body>
	<div class="wrapper">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class=" dropdown-toggle" href="#" id="messageDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								</i> <span class="text-white"><?php echo e(__('layouts.Notifications')); ?> </span><i class="fa fa-chevron-down text-white"></i>
							</a>
							<ul class="dropdown-menu messages-notif-box animated fadeIn" aria-labelledby="messageDropdown">	
								<li>
									...
									<div align="center">
										<a href="/notifications"> &nbsp;<?php echo e(__('layouts.View_all')); ?></a>
										<br><br>
									</div>
								</li>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										<div class="dropdown-divider"></div>										
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/dashboard"><span class="fa fa-desktop"></span> &nbsp;<?php echo e(__('layouts.Dashboard')); ?></a>
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/wallet"><span class="fa fa-folder"></span>&nbsp; <?php echo e(__('layouts.Deposit')); ?></a>
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/send_money"><span class="fa fa-paper-plane"></span>&nbsp; <?php echo e(__('layouts.Transfer_Fund')); ?></a>
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/investments"><span class="fa fa-wallet"></span>&nbsp; <?php echo e(__('layouts.My_Investments')); ?></a>
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/withdrawal"><span class="fa fa-download"></span>&nbsp; <?php echo e(__('layouts.Withdrawal')); ?></a>
										<a class="dropdown-item" href="/<?php echo e($user->username); ?>/downlines"><span class="fa fa-users"></span>&nbsp; <?php echo e(__('layouts.Downlines')); ?></a>
										<a class="dropdown-item" href="<?php echo e(route('ticket.index')); ?>">
											<span class="fab fa-teamspeak"></span>&nbsp; <?php echo e(__('layouts.Contact_Support')); ?>
										...
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="/logout"><span class="fa fa-arrow-right"></span> &nbsp;<?php echo e(__('layouts.Logout')); ?></a>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a href="/<?php echo e($user->username); ?>/dashboard">
								...
								<p><?php echo e(__('layouts.Dashboard')); ?></p>
							</a>							
						</li>
						<li class="nav-item">
							<a href="/<?php echo e($user->username); ?>/profile">
								<i class="fas fa-user"></i>
								<p><?php echo e(__('layouts.My_Profile')); ?></p>
							</a>							
						</li>
						<li class="nav-item">
							<a  href="/<?php echo e($user->username); ?>/wallet">
								<i class="fas fa-wallet"></i>
								<p><?php echo e(__('layouts.Wallet_Deposit')); ?></p>
							</a>							
						</li>
						<li class="nav-item">
							<a href="/<?php echo e($user->username); ?>/send_money">
								<i class="fas fa-paper-plane"></i>
								<p><?php echo e(__('layouts.Transfer_Fund')); ?></p>
							</a>
						</li>
						<li class="nav-item">
							<a href="/<?php echo e($user->username); ?>/investments">
								<i class="fas fa-folder"></i>
								<p><?php echo e(__('layouts.My_Investments')); ?></p>
							</a>							
						</li>
						...
						<li class="nav-item">
							<a href="/<?php echo e($user->username); ?>/withdrawal">
								...
								<p><?php echo e(__('layouts.Withdrawal')); ?></p>
							</a>
						</li>
						<li class="nav-item">
							<a href="/<?php echo e($user->username); ?>/downlines">
								<i class="fas fa-users"></i>
								<p><?php echo e(__('layouts.Downlines')); ?></p>
							</a>							
						</li>
						<li class="nav-item">
							<a href="<?php echo e(route('ticket.index')); ?>">
								<i class="fab fa-teamspeak"></i>
								<p><?php echo e(__('layouts.Contact_Support')); ?></p>
								<?php                                  
						...
						<li class="nav-item">
							<a href="/logout">
								...
								<p><?php echo e(__('layouts.Logout')); ?></p>
							</a>							
						</li>
		...
		<!-- End Sidebar --><?php /**PATH C:\wamp\www\soft.local\core\resources\views/layouts/atlantis/header.blade.php ENDPATH**/ ?>