                                    ...
                                    <div class="row pad_top_20">
                                        <div class="col-lg-6">
                                            <div class="form-group" align="center">
                                                ...
                                                <?php else: ?>
                                                    <img class="img-responsive" src="/img/profile/<?php echo e($user->img); ?>" >
                                                <?php endif; ?>
                                            </div>
                                        </div>  
                                        <div class="col-lg-6">
                                    ...
                                    <table  id="" class="display table table-stripped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="company" > <?php echo e(__('Actions')); ?> </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\dh\core\resources\views/admin/userdetails.blade.php ENDPATH**/ ?>